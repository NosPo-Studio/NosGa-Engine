...
if toLoad.re then
	if global.conf.useLegacyRenderEngine then
		global.core.re = reloadFile(global.core.re, "data/core/re_legacy.lua", global)
	else
...
if toLoad.RenderArea then
	if global.conf.useLegacyRenderEngine then
		global.core.RenderArea = reloadFile(global.core.RenderArea, "data/core/RenderArea_legacy.lua", global)
	else
...
if toLoad.GameObject then
	if global.conf.useLegacyRenderEngine then
		global.core.GameObject = reloadFile(global.core.GameObject, "data/core/GameObject_legacy.lua", global)
	else
