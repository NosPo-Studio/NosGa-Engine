...
function GameObject.new(args)
	...
	this.ngeDraw = function(this, renderArea) --parent func
		...
		if global.conf.useDoubleBuffering then
			global.db.setNonDrawAreas(realArea.gameObjectAttributes[this].nonDrawAreas)
			global.db.setDrawAreas(realArea.gameObjectAttributes[this].drawAreas)
			global.db.setDrawAreaOffset(offsetX, offsetY)
			
			--global.log(this.ngeAttributes.name)
			--global.log("DAs:", global.ut.tostring(realArea.gameObjectAttributes[this].drawAreas, false))
			--global.log("NDAs:", global.ut.tostring(realArea.gameObjectAttributes[this].nonDrawAreas, false))
		end
		...
		if global.conf.useDoubleBuffering then
			global.db.resetNonDrawAreas()
			global.db.resetDrawAreas()
			global.db.resetDrawAreaOffset()
			realArea.gameObjectAttributes[this].nonDrawAreas = {}
			realArea.gameObjectAttributes[this].drawAreas = {}
		end
