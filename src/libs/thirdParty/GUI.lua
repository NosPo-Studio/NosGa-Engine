...
local function applicationStart(application, eventPullTimeout)
	...
	repeat
		e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17, e18, e19, e20, e21, e22, e23, e24, e25, e26, e27, e28, e29, e30, e31, e32 = coroutine.yield()
...
local function applicationStop(application)
	...
	global.core.uiHandler.ignoreApplication(application)
end
...
function GUI.application(x, y, width, height)
	...
	application.coroutine = coroutine.create(applicationStart)

	application.start = function()
		coroutine.resume(application.coroutine, application, nil)
		global.core.uiHandler.listApplication(application)
	end
